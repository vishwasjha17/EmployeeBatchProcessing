...
public  class MySqlClientPool {
    ...
    public static void main4(String [] args) throws  Exception{
       ...
       // PreparedStatement pstmt = con.prepareStatement(insertQuery,Statement.RETURN_GENERATED_KEYS);
        ...
        PreparedStatement pstmt = con.prepareStatement(insertQuery, Statement.RETURN_GENERATED_KEYS);
        pstmt.setLong(1,1L);
        pstmt.setString(2, "12341235");
        pstmt.setString(3, "vishwas kumar");
        pstmt.setString(4, "7091444909");
        pstmt.setString(5, "abc@gmail.com");
        pstmt.setString(6, "YES");
        pstmt.addBatch();

        pstmt.setLong(1,2L);
        pstmt.setString(2, "1234124341234");
        pstmt.setString(3, "vikram kumar");
        pstmt.setString(4, "7003381857");
        pstmt.setString(5, "xyz@gmail.com");
        pstmt.setString(6, "YES");
        pstmt.addBatch();

        pstmt.setLong(1,3L);
        pstmt.setString(2, "123412434141234");
        pstmt.setString(3, "vikram kumar jha");
        pstmt.setString(4, "7003381857343214");
        pstmt.setString(5, "helloworld@gmail.com");
